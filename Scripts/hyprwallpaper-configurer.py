...
def importScreen(display):
    ...
    if existingConfig == False:
        with open(home / ".config/hypr/hyprpaper.conf", "a") as f:
            f.write(f"preload = /home/icefrost/.config/hypr/utilities/{display}-wallpaper.png\n")
            f.write(f"wallpaper = {display},/home/icefrost/.config/hypr/utilities/{display}-wallpaper.png\n")
            f.close()
